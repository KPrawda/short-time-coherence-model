...
addpath('C:\Users\prawdak1\Dropbox (Aalto)\Projects\Loudspeaker deconvolution\ISM scripts')
...
c = [333, 333.01]%[332.879; 332.90];    % speed of sound in [m/s]
...
%%
save('IR_ISM_small_change.mat', 'h', 'fs')