...
folder='C:\Users\prawdak1\Dropbox (Aalto)\Projects\Time-variance\TimeVaryingCorrelationRIR\Up-to-date code\RIRs';
...
clear ir
li = 1;
for it = 11:15 %% read the IRs: IR_numClosed_50_numComb_5000_mic_1_sweep_x.wav    21:24%
    [ir(:, li), fs] =  audioread(file{it});
    li = li+1;
end

[~, loc_max] = max(abs(ir)); % delete the pre-delay
if loc_max>1
    for it = 1:li-1
